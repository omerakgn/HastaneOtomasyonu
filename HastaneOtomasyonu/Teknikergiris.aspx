...
<body>
    <form id="form1" runat="server">
        <div style="background-color: lightblue; font-size:50px; margin-left:200px" class="auto-style2"> <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TEKNİKER GİRİŞİ</b></div>
        ...
        <div>
            ...
            <div style="height:50px;"> <asp:TextBox ID="Tcno" runat="server" Height="37px" Width="230px" CssClass="textbox1" style="margin-left: 540px" TextMode="Number" ></asp:TextBox >
            ...
            <div style="height:50px;"> <asp:TextBox ID="Sifre" runat="server" Height="37px" Width="230px" CssClass="textbox1" style="margin-left: 540px" ></asp:TextBox ></div>
