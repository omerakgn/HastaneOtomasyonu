...
<body style="height:700px;">
    <form id="form1" runat="server">
        <div>
                    <div style="background-color: lightblue; font-size:50px; " class="auto-style1"> <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; DOKTOR GİRİŞİ</b></div>
        <div class="auto-style2">
            ...
            <div style="height:50px;"> 
                <asp:TextBox ID="Tcno1" runat="server" Height="37px" Width="230px" CssClass="right" style="margin-left: 560px ;" TextMode="Number" AutoCompleteType="Disabled"  ></asp:TextBox >
     ...
     <div style="height:50px;"> <asp:TextBox ID="Sifre1" runat="server" Height="37px" Width="230px" CssClass="right" style="margin-left: 560px" AutoCompleteType="Disabled" TextMode="Password" ></asp:TextBox ></div>
